...
//	Dictionary<Material, UIDrawCall> drawcallSet = new Dictionary<Material,UIDrawCall>();
...
//	{
//		UIDrawCall dcFromSet;
//		if ( this.drawcallSet.TryGetValue( mat, out dcFromSet ) == true )
//		{
//			if ( dcFromSet != null )
//			{
//				return dcFromSet;
...
//	public Vector3 CalculateConstrainOffset (Vector2 min, Vector2 max, bool fromBottom = false)
//	{
...
//		if ( fromBottom == false )
//		{
//			return NGUIMath.ConstrainRectTA(minRect, maxRect, minArea, maxArea);
//		}
//		else
//		{
//			return NGUIMath.ConstrainRectBottomTA(minRect, maxRect, minArea, maxArea);
//		}
//	}
